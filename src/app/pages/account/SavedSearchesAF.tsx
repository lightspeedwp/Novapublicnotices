...
export default function SavedSearchesAF() {
  const [savedSearches] = useState<SavedSearch[]>([
    {
      ...
      lastChecked: "2 uur gelede",
      newResults: 3,
      createdAt: "2026-03-10",
    },
    {
      id: "2",
      name: "Dranklisensies — Wes-Kaap",
      query: "",
      category: "Dranklisensies",
      location: "Wes-Kaap",
      notificationsEnabled: true,
      lastChecked: "5 uur gelede",
      newResults: 1,
      createdAt: "2026-03-08",
    },
    {
      id: "3",
      name: "Boedelkennisgewings",
      query: "",
      category: "Boedels",
      notificationsEnabled: false,
      lastChecked: "1 dag gelede",
      newResults: 0,
      createdAt: "2026-03-01",
    },
    {
      id: "4",
      name: "Stadsbeplanning — Johannesburg",
      query: "hersonering ontwikkeling",
      category: "Stadsbeplanning",
      location: "Gauteng",
      notificationsEnabled: true,
      lastChecked: "3 uur gelede",
      newResults: 5,
  ...
  const toggleNotifications = (id: string) => {
    console.log(`Skakel kennisgewings vir soektog ${id}`);
  };

  const deleteSearch = (id: string) => {
    console.log(`Skrap soektog ${id}`);
  };

  const editSearch = (id: string) => {
    console.log(`Wysig soektog ${id}`);
  };

  const runSearch = (search: SavedSearch) => {
    console.log(`Voer soektog ${search.id} uit`);
  };
          ...
          <main className="flex-1">
            ...
            <div className="mb-8">
              ...
              <p className="text-gray-600">
                Stoor u soekriteria en ontvang kennisgewings wanneer nuwe ooreenstemmende kennisgewings gepubliseer word
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
              <Card className="p-6">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">Gestoorde Soektogte</p>
                  </div>
                </div>
              </Card>
              ...
              <Card className="p-6">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h3 className="font-semibold text-lg mb-1">E-poswaarskuwings</h3>
                    <p className="text-sm text-muted-foreground">Ontvang kennisgewings wanneer nuwe kennisgewings ooreenstem met jou gestoorde soektogte</p>
                  </div>
                </div>
              </Card>
              ...
              <Card className="p-6">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">Nuwe Resultate</p>
                  </div>
                </div>
              </Card>
            </div>
              ...
              {savedSearches.map((search) => (
                <Card key={search.id} className="p-6 hover:shadow-lg transition-shadow">
                  <div className="flex items-start justify-between gap-4 mb-4">
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-gray-500 mb-3">
                        Laas nagegaan: {search.lastChecked}
                      </p>
                    </div>
                    ...
                    <div className="flex items-center gap-2 flex-shrink-0">
                      <Button
                        ...
                        title={search.notificationsEnabled ? "Deaktiveer kennisgewings" : "Aktiveer kennisgewings"}
                      >
                        {search.notificationsEnabled ? (
                      ...
                      <div className="flex items-start gap-2">
                        ...
                        <div>
                          ...
                          <p className="text-sm wpn-text--primary">
                            {search.dateFrom || "Enige"} — {search.dateTo || "Enige"}
                          </p>
                        </div>
                      </div>
                    )}
                  ...
                  >
                    ...
                    Voer Soektog Uit
                    {search.newResults > 0 && ` (${search.newResults} nuut)`}
                  </Button>
                </Card>
              ))}
            </div>
            ...
            {savedSearches.length === 0 && (
              <Card className="p-12 text-center">
                ...
                <h3 className="wpn-heading-h3 wpn-heading--primary mb-2">
                  Geen gestoorde soektogte nog nie
                </h3>
                <p className="text-gray-600 mb-6">
                  Skep 'n gestoorde soektog om in kennis gestel te word wanneer nuwe ooreenstemmende kennisgewings gepubliseer word
                </p>
                <Button className="wpn-button wpn-button--accent gap-2">
                  <Plus className="size-5" />
                  Skep U Eerste Soektog
                </Button>
              </Card>
            )}
            ...
            <Card className="p-6 mt-8 border-l-4 wpn-border-left--accent bg-blue-50">
              <h4 className="font-semibold wpn-text--primary mb-2">
                💡 Hoe gestoorde soektogte werk
              </h4>
              <ul className="text-sm text-gray-700 space-y-1">
                <li>• Soektogte loop outomaties elke 6 uur</li>
                <li>• Aktiveer kennisgewings om e-poswaarskuwings vir nuwe resultate te ontvang</li>
                <li>• U kan tot 10 soektogte op u rekening stoor</li>
                <li>• Wysig of skrap soektogte op enige tyd</li>
              </ul>
            </Card>
          </main>
        </div>
