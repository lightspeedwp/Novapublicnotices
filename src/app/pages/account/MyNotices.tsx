...
import { Calendar, MapPin, FileText, Eye, Edit, Trash2, FileCheck, Clock, FilePlus } from "lucide-react";
    ...
    <Layout lang={lang} showAds={true}>
      <div className="wpn-my-notices">
        <div className="wpn-my-notices__container">
          {/* Header */}
          <div className="wpn-my-notices__header">
            <h1 className="wpn-my-notices__title">{data.title[lang]}</h1>
            <p className="wpn-my-notices__subtitle">{data.subtitle[lang]}</p>
          </div>
