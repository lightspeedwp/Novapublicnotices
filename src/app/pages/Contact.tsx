      ...
      <div className="bg-background py-12">
        <div className="container mx-auto px-4 max-w-6xl">
          ...
          <div className="mb-12 p-6 bg-card border border-border rounded-lg text-center">
            ...
            <h3 className="mb-2">{socialMediaInfo.facebook.text.en}</h3>
            <div className="flex items-center justify-center gap-3 mb-4">
              <span className="text-muted-foreground">{socialMediaInfo.general.text.en}</span>
            </div>
          ...
          {/* Regional Contacts */}
          <div className="mb-12">
            <h2 className="mb-6">{regionalContactsHeader.title.en}</h2>
          ...
          <div className="mb-12">
            <h2 className="mb-6">{helpSectionHeader.title.en}</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {contactCategories.map((category, idx) => (
                <Card key={idx} className="p-6">
                  <h4 className="mb-2">{category.title.en}</h4>
            ...
            <form className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  <label htmlFor="name" className="block mb-2">
                    {contactFormLabels.name.en} <span className="text-destructive">*</span>
                  </label>
                  <Input
                    id="name"
                ...
                <div>
                  <label htmlFor="email" className="block mb-2">
                    {contactFormLabels.email.en} <span className="text-destructive">*</span>
                  </label>
                  <Input
                    id="email"
                    type="email"
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  <label htmlFor="subject" className="block mb-2">
                    {contactFormLabels.subject.en} <span className="text-destructive">*</span>
                  </label>
                  <Input
                    id="subject"
              ...
              <div>
                <label htmlFor="message" className="block mb-2">
                  {contactFormLabels.message.en} <span className="text-destructive">*</span>
                </label>
                <Textarea
                  id="message"
                  rows={6}
