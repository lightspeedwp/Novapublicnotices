...
The repo uses Lexend as the primary typeface. Keep one primary typeface unless a second approved face is intentionally introduced.
...
- `/guidelines/design-tokens/spacing.md` — Typography spacing
- `/guidelines/locale-architecture.md` — Bilingual content
